...
public class RenderScytheProjectileWhite extends EntityRenderer<EntityScytheProjectileWhite> {
    ...
    public RenderScytheProjectileWhite(EntityRendererProvider.Context renderManager) {
        super(renderManager);
    }
    ...
    @Override
    public void render(EntityScytheProjectileWhite entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
