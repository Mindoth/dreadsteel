...
public class RenderScytheProjectileBlack extends EntityRenderer<EntityScytheProjectileBlack> {

    private ItemStack PROJECTILE = new ItemStack(DreadsteelItems.SCYTHE_PROJECTILE_BLACK.get());

    public RenderScytheProjectileBlack(EntityRendererManager renderManager) {
        super(renderManager);
    }

    @Override
    public ResourceLocation getTextureLocation(EntityScytheProjectileBlack entity) {
        return AtlasTexture.LOCATION_BLOCKS;
    }

    @Override
    public void render(EntityScytheProjectileBlack entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
