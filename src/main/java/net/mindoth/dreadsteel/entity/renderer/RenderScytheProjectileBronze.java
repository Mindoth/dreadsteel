...
public class RenderScytheProjectileBronze extends EntityRenderer<EntityScytheProjectileBronze> {
    ...
    public RenderScytheProjectileBronze(EntityRendererManager renderManager) {
        super(renderManager);
    }
    ...
    @Override
    public void render(EntityScytheProjectileBronze entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
