...
public class EntityScytheProjectileBlack extends AbstractArrowEntity {

    public EntityScytheProjectileBlack(EntityType<? extends AbstractArrowEntity> type, World worldIn) {
        super(type, worldIn);
        this.setBaseDamage(DreadsteelCommonConfig.SCYTHE_DAMAGE.get() + 1);
    }

    public EntityScytheProjectileBlack(EntityType<? extends AbstractArrowEntity> type, World worldIn, double x, double y, double z,
    ...
    public EntityScytheProjectileBlack(EntityType<? extends AbstractArrowEntity> type, World worldIn, LivingEntity shooter, double dmg) {
        super(type, shooter, worldIn);
        this.setBaseDamage(dmg);
    }

    public EntityScytheProjectileBlack(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn) {
