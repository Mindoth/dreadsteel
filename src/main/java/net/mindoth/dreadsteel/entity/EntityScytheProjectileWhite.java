...
public class EntityScytheProjectileWhite extends AbstractArrow {
    ...
    public EntityScytheProjectileWhite(EntityType<? extends AbstractArrow> type, Level worldIn, double x, double y, double z,
    ...
    private void spawnParticles() {
        //Particles
        for (int i = 0; i < 8; ++i) {
            this.level.addParticle(ParticleTypes.FIREWORK, this.getX(), this.getY() + 0.5f, this.getZ(), (this.random.nextDouble() - 0.5D) * 1.5D, -this.random.nextDouble() + 1, (this.random.nextDouble() - 0.5D) * 1.5D);
        }
    }
